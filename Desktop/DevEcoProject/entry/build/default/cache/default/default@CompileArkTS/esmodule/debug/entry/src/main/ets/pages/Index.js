...
class Index extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.pageConfig = {
            environment: {
                title: '环境监测',
                icon: { "id": 16777230, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" },
                subPages: [
                    { id: 'temperature', name: '温湿度监测', icon: { "id": 16777253, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#87CEFA' },
                    { id: 'co2', name: 'CO2监测', icon: { "id": 16777228, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#98FB98' },
                    { id: 'pressure', name: '压强监测', icon: { "id": 16777247, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#FFA07A' },
                    { id: 'light', name: '光照监测', icon: { "id": 16777245, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#FFD700' },
                    { id: 'infrared', name: '红外检测', icon: { "id": 16777248, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#BA68C8' },
                    { id: 'watersensor', name: '水浸检测', icon: { "id": 16777258, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#4FC3F7' }
                ]
            },
            mainPages: [
                { id: 'fan', name: '智能新风', icon: { "id": 16777232, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#FF6347' },
                { id: 'alarm', name: '安防管理', icon: { "id": 16777223, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#FF4500' },
                { id: 'deepseek', name: 'AI智能分析', icon: { "id": 16777222, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, color: '#4CAF50' }
            ]
        };
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (this.isEnvironmentMenuOpen || this.subPage) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    ForEach.pop();
                    // 返回主界面按钮
                    this.MenuButton.bind(this)('返回主界面', { "id": 16777233, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" }, false, '#FFCC99', () => this.goHome());
                    Column.pop();
                });
            }
            // 主菜单按钮
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (this.subPage === 'temperature') {
                ...
                this.ifElseBranchUpdateFunction(9, () => {
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Image.create({ "id": 16777250, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" });
                        Image.width('100%');
                        Image.height(200);
