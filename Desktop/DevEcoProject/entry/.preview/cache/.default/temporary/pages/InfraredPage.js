...
class InfraredPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        super(parent, __localStorage, elmtId);
        this.__count = new ObservedPropertySimplePU('--', this, "count");
    ...
    async fetchInfraredData(retryCount = 3) {
        if (retryCount <= 0) {
        ...
        try {
            ...
            this.errorMessage = '';
            this.warningLevel = 0;
            const url = 'http://192.168.3.4:81/api/data/infrared';
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/InfraredPage.ets(92:5)");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 顶部标题栏
            Row.create();
            Row.debugLine("pages/InfraredPage.ets(94:7)");
            // 顶部标题栏
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/InfraredPage.ets(95:9)");
            Image.width(40);
            Image.height(40);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('红外检测计数');
            Text.debugLine("pages/InfraredPage.ets(100:9)");
            Text.fontSize(24);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 主显示区域
            Stack.create();
            Stack.debugLine("pages/InfraredPage.ets(108:7)");
            // 主显示区域
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Circle.debugLine("pages/InfraredPage.ets(110:9)");
            // 背景圆形
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 主数值
            Column.create();
            Column.debugLine("pages/InfraredPage.ets(115:9)");
            if (!isInitialRender) {
                // 主数值
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/InfraredPage.ets(116:11)");
            Text.fontSize(60);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('次');
            Text.debugLine("pages/InfraredPage.ets(121:11)");
            Text.fontSize(24);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 状态指示器
            Row.create();
            Row.debugLine("pages/InfraredPage.ets(130:7)");
            // 状态指示器
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/InfraredPage.ets(131:9)");
            Text.fontSize(16);
            Text.fontColor(this.getTextColor());
            Text.padding(8);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 数据更新时间
            Row.create();
            Row.debugLine("pages/InfraredPage.ets(141:7)");
            if (!isInitialRender) {
                // 数据更新时间
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/InfraredPage.ets(142:9)");
            Image.width(16);
            Image.height(16);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/InfraredPage.ets(147:9)");
            Text.fontSize(14);
            ...
            if (this.isLoading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("pages/InfraredPage.ets(154:9)");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Row.create();
                        Row.debugLine("pages/InfraredPage.ets(160:9)");
                        Row.margin({ top: 20 });
                        if (!isInitialRender) {
                            Row.pop();
                        }
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/InfraredPage.ets(161:11)");
                        Image.width(16);
                        Image.height(16);
                        Image.margin({ right: 5 });
                        if (!isInitialRender) {
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("pages/InfraredPage.ets(166:11)");
                        Text.fontSize(14);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 信息卡片
            Column.create();
            Column.debugLine("pages/InfraredPage.ets(174:7)");
            // 信息卡片
            Column.width('90%');
            // 信息卡片
            Column.padding(15);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('红外检测说明');
            Text.debugLine("pages/InfraredPage.ets(175:9)");
            Text.fontSize(16);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('检测到的人员经过次数');
            Text.debugLine("pages/InfraredPage.ets(181:9)");
            Text.fontSize(14);
            Text.fontColor('#666666');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('警告阈值: >10次/5分钟');
            Text.debugLine("pages/InfraredPage.ets(186:9)");
            Text.fontSize(14);
