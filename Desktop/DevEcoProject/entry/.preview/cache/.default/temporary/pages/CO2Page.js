...
class CO2Page extends ViewPU {
    ...
    async fetchCO2Data(retryCount = 3) {
        ...
        try {
            ...
            this.errorMessage = '';
            this.warningLevel = 0;
            const url = 'http://192.168.3.4:81/api/data/CO2';
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/CO2Page.ets(95:5)");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 顶部标题栏
            Row.create();
            Row.debugLine("pages/CO2Page.ets(97:7)");
            // 顶部标题栏
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/CO2Page.ets(98:9)");
            Image.width(40);
            Image.height(40);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(103:9)");
            Text.fontSize(24);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 主显示区域
            Stack.create();
            Stack.debugLine("pages/CO2Page.ets(111:7)");
            // 主显示区域
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Circle.debugLine("pages/CO2Page.ets(113:9)");
            // 背景圆形
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 主数值
            Column.create();
            Column.debugLine("pages/CO2Page.ets(118:9)");
            if (!isInitialRender) {
                // 主数值
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(119:11)");
            Text.fontSize(60);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(124:11)");
            Text.fontSize(24);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 状态指示器
            Row.create();
            Row.debugLine("pages/CO2Page.ets(133:7)");
            // 状态指示器
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(134:9)");
            Text.fontSize(16);
            Text.fontColor(this.getTextColor());
            Text.padding(8);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 数据更新时间
            Row.create();
            Row.debugLine("pages/CO2Page.ets(144:7)");
            if (!isInitialRender) {
                // 数据更新时间
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/CO2Page.ets(145:9)");
            Image.width(16);
            Image.height(16);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(150:9)");
            Text.fontSize(14);
            ...
            if (this.isLoading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("pages/CO2Page.ets(157:9)");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Row.create();
                        Row.debugLine("pages/CO2Page.ets(163:9)");
                        Row.margin({ top: 20 });
                        if (!isInitialRender) {
                            Row.pop();
                        }
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/CO2Page.ets(164:11)");
                        Image.width(16);
                        Image.height(16);
                        Image.margin({ right: 5 });
                        if (!isInitialRender) {
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("pages/CO2Page.ets(169:11)");
                        Text.fontSize(14);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 信息卡片
            Column.create();
            Column.debugLine("pages/CO2Page.ets(177:7)");
            // 信息卡片
            Column.width('90%');
            // 信息卡片
            Column.padding(15);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(178:9)");
            Text.fontSize(16);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/CO2Page.ets(184:9)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/CO2Page.ets(185:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(186:13)");
            Text.fontSize(14);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('正常范围');
            Text.debugLine("pages/CO2Page.ets(189:13)");
            Text.fontSize(12);
            Text.fontColor('#888888');
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/CO2Page.ets(195:11)");
            Column.margin({ right: 20 });
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(196:13)");
            Text.fontSize(14);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('警告');
            Text.debugLine("pages/CO2Page.ets(199:13)");
            Text.fontSize(12);
            Text.fontColor('#888888');
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/CO2Page.ets(205:11)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/CO2Page.ets(206:13)");
            Text.fontSize(14);
            Text.fontColor('#FF3B30');
            if (!isInitialRender) {
                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('危险');
            Text.debugLine("pages/CO2Page.ets(209:13)");
            Text.fontSize(12);
            Text.fontColor('#888888');
            if (!isInitialRender) {
                Text.pop();
