...
class FanControlPage extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/FanControlPage.ets(38:7)");
            // 顶部标题
            Text.fontSize(24);
            // 顶部标题
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 主内容区域卡片
            Column.create();
            Column.debugLine("pages/FanControlPage.ets(45:7)");
            // 主内容区域卡片
            Column.width('90%');
            // 主内容区域卡片
            Column.padding(20);
            ...
            if (this.isLoading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        // 加载状态
                        Column.create();
                        Column.debugLine("pages/FanControlPage.ets(48:11)");
                        // 加载状态
                        Column.width('100%');
                        // 加载状态
                        Column.height(200);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("pages/FanControlPage.ets(49:13)");
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Text.create('正在连接设备...');
                        Text.debugLine("pages/FanControlPage.ets(54:13)");
                        Text.fontSize(16);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("pages/FanControlPage.ets(63:11)");
                        Column.width('100%');
                        if (!isInitialRender) {
                            Column.pop();
                        }
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        // 信息卡片
                        Column.create();
                        Column.debugLine("pages/FanControlPage.ets(65:13)");
                        // 信息卡片
                        Column.width('90%');
                        // 信息卡片
                        Column.padding(15);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Text.create('温度监测');
                        Text.debugLine("pages/FanControlPage.ets(66:15)");
                        Text.fontSize(18);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Row.create();
                        Row.debugLine("pages/FanControlPage.ets(72:15)");
                        Row.margin({ bottom: 8 });
                        if (!isInitialRender) {
                            Row.pop();
                        }
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/FanControlPage.ets(73:17)");
                        Image.width(24);
                        Image.height(24);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Text.create('(设定阈值: 20°C)');
                        Text.debugLine("pages/FanControlPage.ets(78:17)");
                        Text.fontSize(14);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("pages/FanControlPage.ets(84:15)");
                        Text.fontSize(14);
                        Text.fontColor('#616161');
                        ...
                        if (this.eventLog) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Column.create();
                                    Column.debugLine("pages/FanControlPage.ets(97:15)");
                                    Column.width('90%');
                                    Column.padding(15);
                                    Column.borderRadius(12);
                                    Column.backgroundColor('#FFFFFF');
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Row.create();
                                    Row.debugLine("pages/FanControlPage.ets(98:17)");
                                    Row.margin({ bottom: 5 });
                                    if (!isInitialRender) {
                                        Row.pop();
                                    }
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Image.create(this.eventLog.includes('成功') ? { "id": 16777223, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" } : { "id": 16777257, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" });
                                    Image.debugLine("pages/FanControlPage.ets(99:19)");
                                    Image.width(20);
                                    Image.height(20);
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("pages/FanControlPage.ets(104:19)");
                                    Text.fontSize(16);
                                    Text.fontWeight(FontWeight.Medium);
                                    if (!isInitialRender) {
                                        Text.pop();
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("pages/FanControlPage.ets(110:17)");
                                    Text.fontSize(14);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("pages/FanControlPage.ets(126:13)");
                        // 按钮区域
                        Column.width('100%');
                        // 按钮区域
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("pages/FanControlPage.ets(127:15)");
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("pages/FanControlPage.ets(137:15)");
