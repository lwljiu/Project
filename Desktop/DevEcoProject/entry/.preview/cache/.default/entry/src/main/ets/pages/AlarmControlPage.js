...
class AlarmControlPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/AlarmControlPage.ets(36:5)");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 顶部标题
            Text.create('安防管理系统');
            Text.debugLine("pages/AlarmControlPage.ets(38:7)");
            // 顶部标题
            Text.fontSize(24);
            // 顶部标题
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 主内容区域卡片
            Column.create();
            Column.debugLine("pages/AlarmControlPage.ets(45:7)");
            // 主内容区域卡片
            Column.width('90%');
            // 主内容区域卡片
            Column.padding(20);
            ...
            if (this.isLoading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        // 加载状态
                        Column.create();
                        Column.debugLine("pages/AlarmControlPage.ets(48:11)");
                        // 加载状态
                        Column.width('100%');
                        // 加载状态
                        Column.height(200);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("pages/AlarmControlPage.ets(49:13)");
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Text.create('正在发送请求...');
                        Text.debugLine("pages/AlarmControlPage.ets(54:13)");
                        Text.fontSize(16);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("pages/AlarmControlPage.ets(63:11)");
                        Column.width('100%');
                        if (!isInitialRender) {
                            Column.pop();
                        }
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        // 信息卡片
                        Column.create();
                        Column.debugLine("pages/AlarmControlPage.ets(65:13)");
                        // 信息卡片
                        Column.width('90%');
                        // 信息卡片
                        Column.padding(15);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Text.create('系统说明');
                        Text.debugLine("pages/AlarmControlPage.ets(66:15)");
                        Text.fontSize(18);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("pages/AlarmControlPage.ets(72:15)");
                        Text.fontSize(14);
                        Text.fontColor('#666666');
                        ...
                        if (this.eventLog) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Column.create();
                                    Column.debugLine("pages/AlarmControlPage.ets(85:15)");
                                    Column.width('90%');
                                    Column.padding(15);
                                    Column.borderRadius(12);
                                    Column.backgroundColor('#FFFFFF');
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("pages/AlarmControlPage.ets(86:17)");
                                    Text.fontSize(16);
                                    Text.fontWeight(FontWeight.Medium);
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("pages/AlarmControlPage.ets(91:17)");
                                    Text.fontSize(14);
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("pages/AlarmControlPage.ets(107:13)");
                        // 按钮区域
                        Column.width('100%');
                        // 按钮区域
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("pages/AlarmControlPage.ets(108:15)");
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("pages/AlarmControlPage.ets(118:15)");
